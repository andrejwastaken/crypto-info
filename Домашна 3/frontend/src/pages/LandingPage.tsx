		...
		<div className="container mx-auto px-4 py-8">
			...
			<div className="mb-8 grid grid-cols-1 lg:grid-cols-2 gap-4">
							...
							<div>
								...
								<div className="space-y-1.5">
									{predictions.top.map((pred, idx) => (
										<div
											key={pred.symbol}
											className="flex items-center justify-between p-2.5 bg-green-50 rounded border border-green-200 hover:bg-green-100 transition-colors"
										>
							...
							<div>
								...
								<div className="space-y-1.5">
									{predictions.bottom.map((pred, idx) => (
										<div
											key={pred.symbol}
											className="flex items-center justify-between p-2.5 bg-red-50 rounded border border-red-200 hover:bg-red-100 transition-colors"
										>
											<div className="flex items-center gap-2">
												<span className="text-xs font-semibold text-gray-500 w-5">
													#{idx + 1}
				...
				{!onChainLoading && onChainMetrics.length > 0 && (
					<div className="bg-white border border-gray-300 rounded-lg shadow-sm p-4 lg:col-span-1 lg:max-w-none">
						<div className="flex items-center justify-center gap-2 mb-3">
							<h2 className="text-2xl font-bold text-gray-800">
								On-Chain Metrics
							</h2>
						...
						<div className="space-y-2 flex flex-col">
							{onChainMetrics.map((metric) => (
								<div
									key={metric.symbol}
									className="grid grid-cols-10 gap-1 items-center py-[13px] px-3 bg-blue-50 rounded border border-blue-200 hover:bg-blue-100 transition-colors"
								>
									<div className="col-span-1">
										<Link
											to={`/coins/${metric.symbol.replace("-USD", "")}`}
