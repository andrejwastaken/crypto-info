	...
	return (
		<div className="container mx-auto px-4 py-8 max-w-5xl">
			...
			<div className="space-y-12">
				...
				<section className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
					...
					<div className="mb-8">
						...
						<p className="text-gray-600 leading-relaxed mb-3">
							...
							/>
							neural networks to forecast cryptocurrency price movements for the
							next day. The model is trained on historical price data, including
							open, high, low, close, and volume information. It is evaluated
							using{" "}
							<LinkWrapper
								text="RMSE"
						...
						<p className="text-gray-600 leading-relaxed mb-3">
							...
							predictions are updated daily and displayed on the landing page to
							help users identify potential opportunities.
						</p>
						<p className="text-gray-600 leading-relaxed italic text-sm">
							Note: Past performance is not indicative of future results. Always
					...
					<div className="mb-8">
						...
						<p className="text-gray-600 leading-relaxed mb-3">
							...
							health. These metrics are collected directly from blockchain data
							and exchange APIs to give you a comprehensive view of each
						...
						<div className="bg-gray-50 rounded p-4 mb-3">
							...
							<ul className="space-y-2 text-gray-600 text-sm">
								<li>
									<strong>Active Addresses:</strong> Number of unique addresses
									participating in transactions, indicating network activity
								</li>
								<li>
									<strong>Transactions:</strong> Total number of transactions on
									the network
								</li>
								<li>
								...
								<li>
									<strong>TVL (Total Value Locked):</strong> Total value locked
									in DeFi protocols for that cryptocurrency
								</li>
							</ul>
						</div>
				...
				<section className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
					...
					<div className="mb-8">
						...
						<p className="text-gray-600 leading-relaxed mb-3">
							...
							provide a comprehensive signal score ranging from -1 (Strong Sell)
							to +1 (Strong Buy). The analysis is available in three timeframes:
							daily, weekly, and monthly.
						</p>
						<div className="bg-gray-50 rounded p-4 mb-3">
							<h4 className="font-semibold text-gray-700 mb-2">Oscillators:</h4>
							<ul className="space-y-2 text-gray-600 text-sm mb-4">
								...
								<li>
									...
									indicator identifying momentum by comparing closing prices to
									price ranges.
								</li>
								<li>
									<strong>
								...
								<li>
									...
									indicator comparing positive and negative directional movement
							...
							<p className="text-gray-600 text-sm mt-3">
								...
								boost or dampen the final score, confirming price movements with
								volume trends.
							</p>
						</div>
						<p className="text-gray-600 leading-relaxed">
					...
					<div className="mb-8">
						...
						<p className="text-gray-600 leading-relaxed mb-3">
							...
							analyzes its historical price patterns, trading volume, and market
							trends to forecast the closing price for the next trading day.
						</p>
						<p className="text-gray-600 leading-relaxed italic text-sm">
							Note: The model is retrained periodically with new data to improve
							accuracy, but all predictions should be used as one of many tools
							in your analysis, not as the sole basis for trading decisions.
						</p>
					</div>
					...
					<div className="mb-8">
						...
						<p className="text-gray-600 leading-relaxed mb-3">
							...
							/>{" "}
							that ensures smooth operation, eliminates duplicates, and fills in
							any missing values.
						</p>
						<p className="text-gray-600 leading-relaxed mb-3">
						...
						<ul className="list-disc list-inside text-gray-600 mb-3 space-y-1">
							<li>
								<strong>Line Chart:</strong> Shows the closing price trend over
								time, ideal for quick visualization of price movements
							</li>
							<li>
					...
					<div>
						...
						<p className="text-gray-600 leading-relaxed mb-3">
							...
							/>
							to determine whether the content is positive, negative, or neutral
							regarding the cryptocurrency. More specifically, we use the{" "}
							<LinkWrapper
								text="FinBERT model"
								link="https://github.com/ProsusAI/finBERT"
							/>
							that is trained specifically for tasks in the finance domain to
							ensure the sentiments are as accurate as possible. This helps you
							quickly gauge market sentiment and understand the context behind
							price movements.
						</p>
						<p className="text-gray-600 leading-relaxed">
							Articles are ranked by relevance and recency, ensuring you see the
							most important and recent news first. The sentiment score is
				...
				<section className="bg-yellow-50 border-l-4 border-yellow-300 p-6 rounded">
					...
					<p className="text-yellow-700 text-sm leading-relaxed">
						...
						advice or a recommendation to buy, sell, or hold any cryptocurrency.
						Always conduct your own research and consult with a qualified
						financial advisor before making investment decisions. Cryptocurrency
						investments carry significant risks, and you should never invest
