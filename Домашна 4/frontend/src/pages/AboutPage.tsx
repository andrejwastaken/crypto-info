				...
				<div className="space-y-12">
					<section className="bg-amber-100 rounded-lg border border-amber-400 shadow-sm p-6">
						...
						<p className="text-slate-700 leading-relaxed mb-3">
							CryptoInfo is a comprehensive cryptocurrency analysis platform
							that allows users to access, visualize, and analyze historical
							data for the top 1,000 active cryptocurrencies. The primary focus
							is placed on the collection and processing of daily data spanning
							at least the last 10 years (or the maximum available period for
							each currency), thereby creating a foundation for technical
							analysis and the tracking of market trends.
						</p>
						<p className="text-slate-700 leading-relaxed mb-3">
							The platform combines multiple data sources and analytical
							approaches to provide a detailed view of the cryptocurrency
							market:
						</p>
						<ul className="list-disc list-inside text-slate-700 space-y-2 mb-3">
							<li>
								<strong>AI-Powered Predictions:</strong> Using LSTM neural
								networks to forecast next-day price movements based on
								historical patterns.
							</li>
							<li>
								<strong>On-Chain Analytics:</strong> Real-time blockchain
								metrics such as active addresses, transaction volumes, exchange
								flows, and DeFi TVL.
							</li>
							<li>
								<strong>Technical Analysis:</strong> Comprehensive scoring
								system combining oscillators and moving averages across multiple
								timeframes.
							</li>
							<li>
								<strong>Sentiment Analysis:</strong> NLP-powered analysis of
					...
					<section className="bg-amber-100 rounded-lg border border-amber-400 shadow-sm p-6">
						...
						<p className="text-slate-700">Email: cryptoinfo@gmail.com</p>
